  ...
  <div class="container">
    <div class="foot-grid">
      <div>
        ...
        <p class="foot-alias" data-i18n="footer.alias">StratVerity — sometimes written "Strat Verity" — is an independent audit and certification infrastructure for algorithmic trading strategies (MQL, Python, Pine Script).</p>
      </div>
