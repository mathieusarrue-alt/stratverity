  ...
  <div class="container">
    ...
    <div class="locked" data-reveal>
      ...
      <div class="veil"><div class="unlock">
        ...
        <p data-i18n="lock.p">Blurred preview of a demonstration report. The full report becomes available once payment is confirmed and computation is complete.</p>
  ...
  <div class="container">
    ...
    <div class="price-grid">
      ...
      <div class="price" data-reveal data-delay="2"><div class="name" data-i18n="pr.c.n">Custom</div><div class="amt" data-i18n="pr.c.amt">from €79<small> / strategy</small></div>
        ...
        <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6 9 17l-5-5"/></svg><span data-i18n="pr.c.2">Explicit multi-context scopes</span></li>
...
<section class="block" id="faq">
  <div class="container">
    ...
    <div class="faq">
      ...
      <details class="qa" data-reveal><summary><span data-i18n="faq.q4">How is the report unlocked?</span><span class="chev"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg></span></summary><div class="a" data-i18n="faq.a4">After payment confirmation, the pipeline runs the compatible audit and publishes the report through a secure link. No browser tab needs to remain open.</div></details>
      ...
      <details class="qa" data-reveal><summary><span data-i18n="faq.q8">Is my source code shared or stored?</span><span class="chev"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg></span></summary><div class="a" data-i18n="faq.a8">No. Your code powers read-only audit computation and is never published, resold or executed with real orders. Analysis is static; operational files are deleted under the retention policy, only fingerprints and order evidence are kept.</div></details>
      <details class="qa" data-reveal><summary><span data-i18n="faq.q9">How do subscriptions and Live Scan access work?</span><span class="chev"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg></span></summary><div class="a" data-i18n="faq.a9">The audit is a one-time payment (no auto-renewal). The recurring Live Scan is invitation-only during beta; no subscription can be charged before validation. Access to a delivered report is temporary and tied to your order.</div></details>
      <details class="qa" data-reveal><summary><span data-i18n="faq.q10">Why not just use MetaTrader or TradingView?</span><span class="chev"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg></span></summary><div class="a" data-i18n="faq.a10">MetaTrader and TradingView remain useful reference engines. StratVerity adds an independent control and documents exactly which tests were performed. Paid audits currently support compatible Python strategies; Pine and MQL remain limited to static diagnostics until their replay is validated.</div></details>
    </div>
  </div>
</section>
