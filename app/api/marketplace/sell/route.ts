 ...
 *  delivery_mode:"invite_protected", offers:[{mode:"one_shot"|"rent_monthly"|"rent_yearly", price_cents}]
 *  (jusqu'à 3 offres, chaque prix fixé librement par le vendeur au-dessus des planchers),
