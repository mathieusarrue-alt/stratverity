...
export default function Home() {
  ...
  return (
    <main>
      <aside className="concept-switcher" aria-label="Comparer les directions visuelles">
        <a href="/">Comparer</a>
        <a className="active" href="/design-a">A · Proof Terminal</a>
        <a href="/design-b">B · Verified Studio</a>
      </aside>
