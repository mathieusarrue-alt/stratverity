  ...
  fr: {
    ...
    pricing: {
      ...
      plans: [
        ...
        ["Radar", "Abonnement futur", "Suivi continu et détection de dérive", "Configurer mon périmètre"],
      ],
